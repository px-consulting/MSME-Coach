import {
  ...
  export const featuresData = [
    ...
    {
      icon: <ClipboardCheck className="h-8 w-8 text-violet-400" />,
    ...
    {
      icon: <DollarSign className="h-8 w-8 text-violet-400" />,
  ...
  export const howItWorksData = [
    {
      icon: <CreditCard className="h-8 w-8 text-violet-400" />,
      title: "1. Create Your Account",
      description:
        "Get started in minutes with our simple and secure sign-up process",
    },
    {
      icon: <UserPen className="h-8 w-8 text-violet-400" />,
